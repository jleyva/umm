...
(function() {
    ...
    $("#page-course_content").live('pagebeforeshow',function() {
        ...
        if(cm !== null){
            ...
            contents += '<a href="#" data-slow3="'+cm.url+'" data-role="button" rel="external" target="_blank">View activity 3</a>';

            contents += '<a href="#" data-slow="'+cm.url+'" data-role="button">View activity in Moodle - window.open</a>';
            
            contents += '<a href="#" data-slow2="'+cm.url+'" data-role="button">View  window.loca.href</a><br><br>';
            
            contents += '<a href="'+cm.url+'" rel="external" target="_blank">View  - link</a><br><br>';
            
            contents += '<a href="'+cm.url+'" rel="external">View in Moodle sin target</a><br><br>';
            
            contents += '<a href="'+cm.url+'">View in Moodle sin target ni rel</a><br><br>'; 
            ...
            $("[data-slow]").click(function(event){
             ...
             $("[data-slow2]").click(function(event){
                event.preventDefault();                
                setTimeout("window.location.href = '"+$(this).attr('data-slow2')+"'",1000);
            });
             $("[data-slow3]").click(function(event){
                $(this).attr('href',$(this).attr('data-slow3'));
            });

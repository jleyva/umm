...
var languages = {"es": "Español", "en": "English", "ca" : "Catalá", "fr" : "Français"};
var defaultLang = "en";
var currentLang = defaultLang;
var langStrings = [];

loadLang('en', function(){ return; });
...
function getString(id){
    var translated = '';
    if(typeof(langStrings[currentLang][id]) !== "undefined"){
        translated = langStrings[currentLang][id];
    }
    else if(typeof(langStrings['en']) != "undefined" && typeof(langStrings['en'][id]) !== "undefined"){
        translated = langStrings['en'][id];
    }
...
function translatePage(){
    logInfo("Translating page");
    $('[data-lang]').map(function(){        
        $(this).text(getString($(this).attr('data-lang')));
    });
}
